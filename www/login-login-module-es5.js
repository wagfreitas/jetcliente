  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(authService, translate, commonService, router, menuCtrl, ss) {
          var _this = this;
          ...
          value: function login() {
            ...
            if (email.length == 0 || this.password.length == 0) {
              ...
              this.authService.login(email, this.password).then(function (authData) {
                ...
                _this2.commonService.showToast(error.message);
              });
            }
          }
        }]);
